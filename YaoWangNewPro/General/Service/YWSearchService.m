...
{
//    NSString * requestMethod = [NSString stringWithFormat:@"products.getlist%@",[self convertParam2String:paramDic]];
...
{
//    NSString * requestMethod = [NSString stringWithFormat:@"autocomplate%@",[self convertParam2String:paramDic]];
//    ResponseInfo *response = [self startRequestWithMethod:requestMethod];
